			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
						<div class="card-title">Edit Materi {{ $materi->judul }}</div>
				...
				<div class="card-body">
					<form method="post" action="{{ route('materi.update', $materi->id) }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="playlist_id" class="form-control" id="">
                        ...
                        <div class="form-group">
                            ...
                            <img src=" {{ asset('uploads/' . $materi->gambar_materi) }}" width="100" alt="" srcset="">
                        </div>
