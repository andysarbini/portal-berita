			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
                        ...
                        <a href="{{ route('slide.create') }}" class="btn btn-primary btn-sm ml-auto"> <i class="fas fa-plus"></i> Tambah</a>
					</div>
				</div>
				<div class="card-body">
                            ...
                            <tbody>
                                @forelse ($slide as $row)    
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('uploads/' . $row->gambar_slide) }}" width="100" alt="" srcset="">
                                        </td>
                                        <td>
